...
*/
[ProtoContract]
public class CreateRoomDef{
	private static CreateRoomDef instance;
	...
	public static void InitData(int index)
    {
       if (instance == null)
       {
           ...
           instance = DeSerial<CreateRoomDef>(data);
       }
    }
	...
	public const int TYPE_过5 = 0;
	public const int TYPE_过J = 1;
	public const int TYPE_过A = 2;
	public const int TYPE_4局 = 3;
	public const int TYPE_8局 = 4;
	public const int TYPE_12局 = 5;
