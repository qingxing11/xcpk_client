...
/// 经典场比牌
/// </summary>
public class UIComparerPoker : WTUIPage<UI_ComparerPoker, ClassicRoomCtrl>
{
    public UIComparerPoker() : base(UIType.PopUp, UIMode.DoNothing, R.UI.CLASSIC)
    {
    }
    ...
    internal IEnumerator Init(int pos0, int pos1, int lossPos, bool isLook, List<PokerVO> pokerVOs,int selfPos)
    {
        UIPage.m_n43.visible = true;
        PlayerSimpleData playerSimpleData0 = CacheManager.ClassRoomPlayers[pos0];
        PlayerSimpleData playerSimpleData1 = CacheManager.ClassRoomPlayers[pos1];
