...
namespace Room
{
	public partial class UI_ReturnPanel : GComponent
	{
		...
		public UI_btn_standup m_btn_standup;
		public UI_btn_bangzhu m_btn_help;

		public const string URL = "ui://es6hjd4tipy3y2v";

		public static UI_ReturnPanel CreateInstance()
		{
			return (UI_ReturnPanel)UIPackage.CreateObject("Room","ReturnPanel");
		}
		...
		public override void ConstructFromXML(XML xml)
		{
			...
			m_btn_standup = (UI_btn_standup)this.GetChildAt(3);
			m_btn_help = (UI_btn_bangzhu)this.GetChildAt(4);
		}
	}
}