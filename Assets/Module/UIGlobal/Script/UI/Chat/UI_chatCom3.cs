...
namespace Chat
{
	public partial class UI_chatCom3 : GComponent
	{
		...
		public const string URL = "ui://kxabpsetotjz5xxv";

		public static UI_chatCom3 CreateInstance()
		{
			return (UI_chatCom3)UIPackage.CreateObject("Chat","chatCom3");
		}
