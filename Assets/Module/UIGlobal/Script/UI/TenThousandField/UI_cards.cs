...
namespace TenThousandField
{
	public partial class UI_cards : GComponent
	{
		...
		public const string URL = "ui://efj6gsloh1lb28";

		public static UI_cards CreateInstance()
		{
			return (UI_cards)UIPackage.CreateObject("TenThousandField","cards");
		}
		...
		public override void ConstructFromXML(XML xml)
		{
			...
			m_n0 = (GLoader)this.GetChildAt(1);
			m_n1 = (GLoader)this.GetChildAt(2);
			m_n2 = (GLoader)this.GetChildAt(3);
		}
	}
}