...
{
	public partial class UI_Pokers5 : GComponent
	{
		...
		public const string URL = "ui://efj6gslory4w3y";

		public static UI_Pokers5 CreateInstance()
		{
			return (UI_Pokers5)UIPackage.CreateObject("TenThousandField","Pokers5");
		}
